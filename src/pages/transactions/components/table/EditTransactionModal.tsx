    ...
    <UModal open={open} onClose={onClose} title="Редактирование транзакции">
      <div className="edit-transaction-modal">
        <TextField
          ...
          label="Описание"
          size="small"
          value={updatedTransaction.comment}
        ...
        <TextField
          ...
          label="Дата"
          size="small"
          value={updatedTransaction.created_at}
          onChange={(e) => handleChange("created_at", e.target.value)}
        />
        <NumberField
          label="Сумма"
          value={Number(updatedTransaction.amount)}
          size="small"
          min={1}
